...
public class Johny extends View {
    ...
    public Johny(Context context) {
        super(context);
        init(null, 0);
    }

    public Johny(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public Johny(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        final TypedArray a = getContext().obtainStyledAttributes(
                attrs, R.styleable.Johny, defStyle, 0);

        mExampleString = a.getString(
                R.styleable.Johny_exampleString);
        mExampleColor = a.getColor(
                R.styleable.Johny_exampleColor,
                mExampleColor);
        // Use getDimensionPixelSize or getDimensionPixelOffset when dealing with
        // values that should fall on pixel boundaries.
        mExampleDimension = a.getDimension(
                R.styleable.Johny_exampleDimension,
                mExampleDimension);

        if (a.hasValue(R.styleable.Johny_exampleDrawable)) {
            mExampleDrawable = a.getDrawable(
                    R.styleable.Johny_exampleDrawable);
